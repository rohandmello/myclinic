...
<html lang="en-US" class="no-js">
    ...
    %>
        ...
        <title>Dr. <%= session.getAttribute("f_name") %> <%= session.getAttribute("l_name") %></title>
            ...
            <div class="pageBody">
                <div class="contentWrapper">
                    ...
                    <%
			           ...
			           %>
	                        <h1>Dr. <%= session.getAttribute("f_name") %> <%= session.getAttribute("l_name") %></h1>
	                        <ul class="noBullets">
	                            <li><a class="button" href="prescription.jsp">Write Prescription</a></li>
	                   ...
	                   <%
	              				...
	              				session.removeAttribute("message");
			           				...
			           				String message = "Please Login Again."+session.getAttribute("f_name");
