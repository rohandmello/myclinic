...
<body>
    ...
    <div class="pageBody">
        ...
        <div class="content">
        <%
        	if(session.getAttribute("f_name") == null || session.getAttribute("l_name") == null || session.getAttribute("access_code") == null){
        ...
        %>
            ...
            <div class="wrap">
            	<div class="floatLeft">
            		<ul class="noBullets">
		            	<li><a class="button" href="edit">Edit Information</a></li>
            	...
            	<div class="floatLeft">
            		<ul class="noBullets">
            			...
            			<li><a class="button" href="scheduleAppointment.jsp?id=0">Make an Appointment</a></li>
		            </ul>
		        </div>
            </div>
            <%
